...
include "koneksi.php";
        ...
        if (empty($_SESSION['namauser']) AND empty($_SESSION['passuser'])) {
            ...
            echo "<a href=logiin.php><b>LOGIN</b></a></center>";
            # code...
        }
        else{
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="aksiartikel.php" method="post" enctype="multipart/form-data">
            ...
            <p><b>Deskripsi:</b><br><textarea type="text" name="deskripsi" rows="5" cols="50" placeholder="Deskripsi" id="komentar" required></textarea></p>

            <p><b>Gambar :</b><br><input type="file" name="img_artikel"></p>
            
            <button type="submit" name="go" value="Kirim">KIRIM</button>
                </form>
 -->
